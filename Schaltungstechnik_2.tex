...
\includegraphics[width=0.48\textwidth]{Grafiken/Bode-Diagramm3}\\\\
$H(j\omega)=\frac{1}{1+\frac{j\omega}{\alpha}}$\\\\
\includegraphics[width=0.48\textwidth]{Grafiken/Bode-Diagramm4}\\\\\\
\underline{Typische Übertragungsfunktionen:}\\\\
\includegraphics[width=0.48\textwidth]{Grafiken/Bode-Diagramm_typisch}\\
